...
namespace EWATER.Services
{
    public partial class AdDashboardService
    {
        ...
        public IEnumerable<OrderRecent> GetAll(object[] parameters)
        {
            ...
            spQuery.Append("SELECT a.OrderID,b.CustomerName,d.StaffName,a.OrderDate,a.Status,c.TotalPrice,a.StaffID ");
            ...
            spQuery.Append("LEFT JOIN Staff d ");
            spQuery.Append("on a.StaffID = d.StaffID ");
